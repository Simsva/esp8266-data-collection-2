...
unsigned long am2320_last_update, co2_last_update, mic_last_update, last_post;
...
void loop()
{
	...
	// Serial.print("plot: ");
	// Serial.print(smoothInput(readChannel(1)));
	// Serial.print(", ");
